...
Análise reproduzível das exportações brasileiras de animais vivos da espécie bovina, combinando **Comex Stat/MDIC**, **IBGE/SIDRA**, **Python** e **Power BI**.

O projeto foi criado para responder perguntas de negócio e inteligência de mercado como:
...
- `2026`: YTD janeiro–agosto, exibido separadamente.
